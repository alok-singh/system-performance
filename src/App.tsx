...
import DBMigrationConfigPage from './components/dbMigrationConfigEdit/main';
	...
	render() {
		return <Navigation items={navigationListProvider(location.pathname)}>
			<Switch>
				...
				<Route exact path="/form-setup/db-migration-config" component={DBMigrationConfigPage} />
				<Route exact path="/form-setup/db-migration-config/:id" component={DBMigrationConfigPage} />
